...
var favorite_restaurant_idb = __webpack_require__(683);
;// CONCATENATED MODULE: ./src/scripts/views/pages/favorite-restaurants/favorite-restaurant-search-presenter.js
...
var template_creator = __webpack_require__(78);
// EXTERNAL MODULE: ./src/scripts/utils/like-button-initiator.js
var like_button_initiator = __webpack_require__(199);
;// CONCATENATED MODULE: ./src/scripts/views/pages/favorite-restaurants/favorite-restaurant-search-view.js
function favorite_restaurant_search_view_typeof(o) { "@babel/helpers - typeof"; return favorite_restaurant_search_view_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, favorite_restaurant_search_view_typeof(o); }
...
function favorite_restaurant_search_view_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, favorite_restaurant_search_view_toPropertyKey(descriptor.key), descriptor); } }
function favorite_restaurant_search_view_createClass(Constructor, protoProps, staticProps) { if (protoProps) favorite_restaurant_search_view_defineProperties(Constructor.prototype, protoProps); if (staticProps) favorite_restaurant_search_view_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function favorite_restaurant_search_view_toPropertyKey(arg) { var key = favorite_restaurant_search_view_toPrimitive(arg, "string"); return favorite_restaurant_search_view_typeof(key) === "symbol" ? key : String(key); }
function favorite_restaurant_search_view_toPrimitive(input, hint) { if (favorite_restaurant_search_view_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (favorite_restaurant_search_view_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
    ...
    value: function showFavoriteRestaurants() {
      ...
      if (restaurants.length) {
        html = restaurants.reduce(function (carry, restaurant) {
          return carry.concat((0,template_creator/* restaurantItemTemplate */.gA)(restaurant));
        }, '');
      } else {
        html = this._getEmptyRestaurantTemplate();
      }
      var restaurantContainer = document.getElementById('restaurants');
      restaurantContainer.innerHTML = html;
      restaurants.forEach(function (restaurant) {
        var likeButton = new like_button_initiator/* default */.Z({
...
;// CONCATENATED MODULE: ./src/scripts/views/pages/favorite-restaurants/favorite-restaurant-show-presenter.js
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            new favorite_restaurant_show_presenter({
              view: view,
              favoriteRestaurants: favorite_restaurant_idb/* default */.Z
            });
...
//# sourceMappingURL=app~fcf2a106.bundle.js.map