...
/* harmony export */ });
/* harmony import */ var _views_pages_detail__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(483);
/* harmony import */ var _views_pages_favorite__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(254);
/* harmony import */ var _views_pages_home__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(360);
...
var DrawerInitiator = {
  init: function init(_ref) {
    ...
    var menuIcon = document.querySelector('.bx-menu'); // Ikon menu (hamburger)
    var closeIcon = document.querySelector('.bx-x'); // Ikon close
    var navLinks = document.querySelectorAll('nav ul li a');
    button.addEventListener('click', function (event) {
      _this._toggleDrawer(event, drawer);
      _this._toggleMenuIcons(menuIcon, closeIcon); // Tukar ikon menu dan close
    });
  ...
  _toggleMenuIcons: function _toggleMenuIcons(menuIcon, closeIcon) {
...
/* harmony export */   Z: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _data_favorite_restaurant_idb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(683);
/* harmony import */ var _views_templates_template_creator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(78);
...
var LikeButtonInitiator = /*#__PURE__*/function () {
  function LikeButtonInitiator(_ref) {
    var likeButtonContainerId = _ref.likeButtonContainerId,
      restaurant = _ref.restaurant;
    _classCallCheck(this, LikeButtonInitiator);
    this._likeButtonContainerId = likeButtonContainerId;
    this._restaurant = restaurant;
  }
  _createClass(LikeButtonInitiator, [{
    key: "renderButton",
    value: function () {
    ...
    key: "_isRestaurantExist",
    value: function () {
      var _isRestaurantExist2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        var restaurant;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _data_favorite_restaurant_idb__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.getRestaurant(id);
            case 2:
              restaurant = _context2.sent;
              return _context2.abrupt("return", !!restaurant);
            case 4:
            case "end":
      ...
      function _isRestaurantExist(_x) {
        return _isRestaurantExist2.apply(this, arguments);
      }
      return _isRestaurantExist;
    }()
  }, {
    key: "_renderLike",
      ...
      likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _data_favorite_restaurant_idb__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.putRestaurant(_this._restaurant);
            case 2:
              _this.renderButton();
            case 3:
            case "end":
      ...
      likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return _data_favorite_restaurant_idb__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.deleteRestaurant(_this2._restaurant.id);
            case 2:
              _this2.renderButton();
            case 3:
            case "end":
...
/* harmony import */ var _routes_url_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(765);
/* harmony import */ var _drawer_initiator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(848);


function markActiveLink() {
  var currentPath = _routes_url_parser__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z.parseActiveUrlWithCombiner();
  var navLinks = document.querySelectorAll('nav ul li a');
  navLinks.forEach(function (link) {
    var linkPath = link.getAttribute('href');
    if (linkPath === "#".concat(currentPath)) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  menu.addEventListener('click', _drawer_initiator__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z);
  markActiveLink();
});
